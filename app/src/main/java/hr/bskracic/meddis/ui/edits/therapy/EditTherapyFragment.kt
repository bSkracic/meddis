...
class EditTherapyFragment : Fragment(R.layout.fragment_edit_therapy) {
//    val viewModel: EditTherapyViewModel by viewModels {
...
//    }
//
//    private var therapyId: Int = 0
//
//    private var therapy: TherapyAndMedicationsWithAlarms = viewModel.getByIdWithMedicationAndAlarms(therapyId)
//
...
//        // Add temp alarms and therapy and then save it, otherwise nothing happens
//    }
//
